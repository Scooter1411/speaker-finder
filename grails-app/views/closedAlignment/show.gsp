	...
	<body>
		...
		<div id="show-closedAlignment" class="content scaffold-show" role="main">
			...
			<ol class="property-list closedAlignment">
				...
				<g:if test="${closedAlignmentInstance?.f3}">
				<li class="fieldcontain">
					<span id="f3-label" class="property-label"><g:message code="closedAlignment.f3.label" default="F3" /></span>
					
						<span class="property-value" aria-labelledby="f3-label"><g:fieldValue bean="${closedAlignmentInstance}" field="f3"/></span>
